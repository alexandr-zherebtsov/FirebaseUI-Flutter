...
class ArLocalizations extends FirebaseUILocalizationLabels {
  ...
  String get credentialAlreadyInUseErrorText =>
      "مقدّم الخدمة هذا مرتبط بحساب مستخدم آخر.";
  ...
  String get enableMoreSignInMethods =>
      "يمكنك تفعيل المزيد من طُرق تسجيل الدخول.";

  @override
  String get enterSMSCodeText => "إدخال رمز رسالة SMS";
  ...
  @override
  String get signInWithFacebookButtonText => "تسجيل الدخول عبر Facebook";

  @override
  String get signInWithGoogleButtonText => "تسجيل الدخول عبر Google";

  @override
  String get signInWithPhoneButtonText => "تسجيل الدخول عبر رقم الهاتف";

  @override
  String get signInWithTwitterButtonText => "تسجيل الدخول عبر Twitter";
  ...
  String get smsAutoresolutionFailedError =>
      "تعذّرت مطابقة رمز SMS تلقائيًا. يُرجى إدخاله يدويًا.";
  ...
  @override
  String get updateLabel => "تعديل";

  @override
  String get userNotFoundErrorText => "تعذّر العثور على الحساب";

  @override
  String get valueLabel => "القيمة";

  @override
  String get verifyCodeButtonText => "إثبات صحة الرمز";
